...
# t2_start
plot(rnorm(500), main = "500 Normalverteilte Zufallszahlen", xlab = "Index", ylab = "Wert")
# t2_ende
...
# t3_start
barplot( WorldPhones / 1000, names.arg = 1951:1960, 
        main = "World Phones in Millions",
        xlab = "Year", ylab = "Number of Phones (in Thousands)",
        col = "lightblue", ylim = c(0, max( WorldPhones / 1000) + 5),
        beside = TRUE)
# t3_ende
